...
import FramesList from '@/components/tradeview/frames-list';
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/ui/tabs';
import Image from 'next/image';

const PURCHASED_FRAMES_KEY = 'tradeview_purchased_frames';

function FramesPageContent() {
  ...
  useEffect(() => {
    const checkPurchases = () => {
      const storedPurchases = localStorage.getItem(PURCHASED_FRAMES_KEY);
      if (storedPurchases) {
          ...
          <div className="container mx-auto max-w-2xl px-2">
            <div className="flex items-center justify-between gap-2 px-2">
              <div className="flex items-center gap-2">
                ...
                <h1 className="text-lg font-bold">Frames</h1>
              </div>
